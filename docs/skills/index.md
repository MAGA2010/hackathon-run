...
| [prize-strategy](prize-strategy.md)     | Pick the prize to chase and position the demo for its judges | `prize.json`        |
...
[`hackathon validate-skill`](../architecture/overview.md#cli-surface), the
[`hackathon skills search`](../architecture/overview.md#cli-surface) subcommand, and
the MCP `find_skills` tool. See [ADR-0009](../architecture/adr/0009-skill-format-v2.md)
...
Use [`hackathon status`](../architecture/overview.md#cli-surface) to see where
you are in this state machine, or [`hackathon flow`](../getting-started/quickstart.md) for the exact commands for the next stage.
