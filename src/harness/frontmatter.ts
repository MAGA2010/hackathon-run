...
export function parseFrontmatter(raw: string): ParseResult {
  ...
  return {
    frontmatter: {
      ...
      side_effects: Array.isArray(fm.side_effects) ? fm.side_effects.map(String) : undefined,
      ...
      homepage: fm.homepage ? String(fm.homepage) : undefined,
      repository: fm.repository ? String(fm.repository) : undefined,
    },
    body,
    triggerBudget,
  };
